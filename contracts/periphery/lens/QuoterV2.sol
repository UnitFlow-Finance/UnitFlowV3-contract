...
import '../../core/interfaces/callback/IUnitFlowV3SwapCallback.sol';
...
contract QuoterV2 is IQuoterV2, IUnitFlowV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IUnitFlowV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IUnitFlowV3Pool) {
        return IUnitFlowV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function unitFlowV3SwapCallback(
        ...
        IUnitFlowV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IUnitFlowV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
